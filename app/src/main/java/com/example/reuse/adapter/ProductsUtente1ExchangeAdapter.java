...
public class ProductsUtente1ExchangeAdapter extends RecyclerView.Adapter<ProductsUtente1ExchangeAdapter.ProductViewHolder> {
    ...
    public ProductsUtente1ExchangeAdapter(Context context, List<Product> newProductList, OnItemClickListener onItemClickListener) {
    ...
    public void onBindViewHolder(ProductViewHolder holder, int position) {
        ...
        System.out.println("img"+product.getImageUrl());
